...
public final class GuiKit {
    ...
    public static void drawRaisedPanel(GuiGraphics g, int x, int y, int w, int h) {
    ...
    public static void drawScrollThumb(GuiGraphics g, int x, int y, int h) {
    ...
    public static void drawXpBar(GuiGraphics g, int x, int y, int w, float progress) {
     ...
     */
    public static int drawWrapped(GuiGraphics g, Font font, Component text, int x, int y,
